public class Bishop extends ChessPiece{
	...
	public Bishop(String color, int x, int y, boolean alive) throws IllegalArgumentException {
	...
	public void checkIfValidMove(int x, int y, int[][] k) {
		...
		if(differenceX>0 && differenceY>0 && differenceY==differenceX) {
			...
			for(int i = differenceX+1; i<0; i++) {
				if(!checkAvailability(x+i, y-i, k)) {
					...
					throw new IllegalArgumentException("ulovlig treekk");
				}
			}
		}
